...
ob_start();
?>
<span data-spa-title="Payment Management — DLA" hidden></span>
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 shrink-0">
  ...
  <div class="flex flex-wrap gap-2">
    ...
    <div class="relative">
      ...
      <div id="paymentFilterMenu" class="hidden absolute left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-auto sm:right-0 mt-1 w-72 sm:w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-20 p-4 action-dropdown">
